const GlobalLoadingScreen = () => {
    return (
        <div className="min-h-screen bg-white flex flex-col items-center justify-center p-6 relative overflow-hidden">
            ...
            <div className="relative flex flex-col items-center max-w-[280px] sm:max-w-xs md:max-w-sm w-full transition-all duration-500">
                {/* Branding Section */}
                <div className="flex flex-col items-center gap-6 mb-12 animate-in fade-in zoom-in duration-700">
                    <div className="relative group">
                        ...
                        <img
                            src="/logo.png"
                            alt="Nerds Room"
                            className="w-20 h-20 sm:w-24 sm:h-24 md:w-28 md:h-28 object-contain relative z-10 rounded-2xl shadow-2xl transition-transform hover:scale-110 duration-500"
                        />
                    </div>

                    <div className="text-center">
                        <h1 className="text-3xl sm:text-4xl md:text-5xl font-black text-nerdBlue tracking-tight">
                            nerds room<span className="text-nerdLime">.</span>
                        </h1>
                        <p className="text-[10px] sm:text-[11px] md:text-xs font-bold text-slate-400 uppercase tracking-[0.3em] mt-2">
                            Innovation Hub
                        </p>
                    </div>
                </div>
                ...
                <div className="w-full space-y-4 px-4 sm:px-0">
                    <div className="w-full h-1.5 sm:h-2 bg-slate-100 rounded-full overflow-hidden relative shadow-inner">
                    ...
                    <div className="flex flex-col items-center gap-2">
                        <p className="text-[9px] sm:text-[10px] md:text-[11px] font-black text-nerdBlue/30 uppercase tracking-[0.4em] animate-pulse">
                            Launching Workspace
                        </p>
                    </div>
                </div>
